...
def generate_router(router_num, as_number, ibgp_peers=None, ebgp_peers=None):
    ...
    for peer in ebgp_peers:
        ...
        router["routing"]["ebgp_peers"].append({
            ...
            "relation": peer.get("relation", "provider") # Par défaut provider
        })
...
# --- Appels de configuration (Exemple pour l'AS 10) ---
# On considère l'AS 20 comme le PROVIDER de l'AS 10
...
# --- Appels pour l'AS 20 (L'AS 20 voit l'AS 10 comme son CUSTOMER) ---
